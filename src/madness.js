...
//evaluate ball position and move it to other side of screen when it exceeds screen width
function evalBallPosition() {
  ...
  if (parseInt(ball.style.left) < -60) {
    document.getElementById("ball").style.left = innerWidth - 60 + "px";
  }
}
